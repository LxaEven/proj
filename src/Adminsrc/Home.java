...
public class Home extends JPanel {
    ...
    private void refreshDashboard() {
        ...
        panel.add(createPanel("Students", totalStudents, "Icon/student_total.png"));
        panel.add(createPanel("Females", totalFemales, "Icon/Female.png"));
        panel.add(createPanel("Courses", totalCourses, "Icon/course.png"));
        panel.add(createPanel("Departments", totalDepartments, "Icon/department.png"));
